...
rgb_front_videos()
{
	...
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1xWlMM2O3Gbp_8LK5FefoH0TVEmae6jIf' 'train_raw_videos.z01'

	### train_raw_videos.z02
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1krtYdpK_LQFgEUCnHxoYAW7EyhLMLWq0' 'train_raw_videos.z02'

	### train_raw_videos.z03
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1fXpWRNFhpuVm3ym7lT9vF_bnDjHkvP_K' 'train_raw_videos.z03'

	### train_raw_videos.z04
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1IFetFt4AzsxNCMZ0VVpX7YRgFAm58X48' 'train_raw_videos.z04'

	### train_raw_videos.z05
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1ZHuuun6Ae-AOLBns3LmuH7w8C9YCB4gH' 'train_raw_videos.z05'

	### train_raw_videos.z06
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1FQQIPblk-oLH_vu7h2tDO0oJaZ3xkp5N' 'train_raw_videos.z06'

	### train_raw_videos.z07
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=19XNgERcolGAMPPgX-Gx_GebSTx3W4o0r' 'train_raw_videos.z07'

	### train_raw_videos.z08
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1YN-SA9uzrogEdKeT6UdQUIcuGEyYJILg' 'train_raw_videos.z08'

	### train_raw_videos.z09
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1SZQ2GzPLCkRqvsImAjULAPBiuAKi9DE9' 'train_raw_videos.z09'

	### train_raw_videos.zip
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1Xe1T5okJiopMXUiH3sc0mdCWNDYSBopd' 'train_raw_videos.zip'
	
	## Val
	### val_raw_videos.zip

	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1fCkyuKSsc7gauljuL9sx_jBomf3N6i0g' 'val_raw_videos.zip'

	## Test
	### test_raw_videos.zip
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1z0i6BBGHQ12ChY63hZH56QnczvQ0JfTb' 'test_raw_videos.zip'
...
rgb_side_videos()
{
	...
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1Rmf6LfNWn6lWkAz6Iuj5pMOI2I5p4j1U' 'train_side_raw_videos.z01'

	### train_side_raw_videos.z02
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1FytIYIRYrBgAeNWIAhO5vnI2mYOvYC9i' 'train_side_raw_videos.z02'

	### train_side_raw_videos.z03
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1kC24jgNgjYYiIYhCRE-gGR28H_2xBBbP' 'train_side_raw_videos.z03'

	### train_side_raw_videos.z04
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1JunkM-ImFYao_MwDW9zeqe-6Th6rOLhR' 'train_side_raw_videos.z04'

	### train_side_raw_videos.z05
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1-vMckelz9fy4GVNYXRCcy7cJ12X4P3KZ' 'train_side_raw_videos.z05'

	### train_side_raw_videos.z06
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1uV413eKsihkNzquN2bwtIQG-OZZMz6sh' 'train_side_raw_videos.z06'

	### train_side_raw_videos.z07
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1sU8xrneFJHBzT_PFz4iRPqI8A7HGilhW' 'train_side_raw_videos.z07'

	### train_side_raw_videos.z08
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1RPLxeZ54uSZUJSXdPFhXOgeIXziOwTW9' 'train_side_raw_videos.z08'

	### train_side_raw_videos.z09
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1tClhr98PszBvFpo9ELKuhbTZZgTGGQqh' 'train_side_raw_videos.z09'

	### train_side_raw_videos.zip
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=10xrXWgH7iW3E6sgJZDPRwlIhIaDLfHQm' 'train_side_raw_videos.zip'
	
	## Val
	### val_rgb_side_raw_videos.zip
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1Z2H96JT68o7eTChEXPI9z3xyx7zUJPl5' 'val_rgb_side_raw_videos.zip'

	## Test
	### test_rgb_side_raw_videos.zip
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1tCQ8KIuuiirXHsh29w0XAMNB3HLIGqgA' 'test_rgb_side_raw_videos.zip'
...
rgb_front_clips()
{
	...
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1VX7n0jjW0pW3GEdgOks3z8nqE6iI6EnW' 'train_rgb_front_clips.zip'

	## Val
	### val_rgb_front_clips.zip
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1DhLH8tIBn9HsTzUJUfsEOGcP4l9EvOiO' 'val_rgb_front_clips.zip'


	## Test
	### test_rgb_front_clips.zip
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1qTIXFsu8M55HrCiaGv7vZ7GkdB3ubjaG' 'test_rgb_front_clips.zip'
...
rgb_side_clips()
{
	...
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1oiw861NGp4CKKFO3iuHGSCgTyQ-DXHW7' 'train_rgb_side_clips.zip'

	## Val
	### val_rgb_side_clips.zip
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1mxL7kJPNUzJ6zoaqJyxF1Krnjo4F-eQG' 'val_rgb_side_clips.zip'

	## Test
	### test_rgb_side_clips.zip
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1j9v9P7UdMJ0_FVWg8H95cqx4DMSsrdbH' 'test_rgb_side_clips.zip'
...
rgb_front_2D_keypoints()
{
	...
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1TBX7hLraMiiLucknM1mhblNVomO9-Y0r' 'train_2D_keypoints.tar.gz'

	## Val
	### val_2D_keypoints.tar.gz
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1JmEsU0GYUD5iVdefMOZpeWa_iYnmK_7w' 'val_2D_keypoints.tar.gz'

	## Test
	### test_2D_keypoints.tar.gz
	sh $DOWNLOAD_SCRIPT 'https://docs.google.com/uc?export=download&id=1g8tzzW5BNPzHXlamuMQOvdwlHRa-29Vp' 'test_2D_keypoints.tar.gz'
